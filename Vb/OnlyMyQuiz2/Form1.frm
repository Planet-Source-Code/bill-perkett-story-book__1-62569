...
'character.Get
  Character.Get "Animation", "MoveingDown", True
  Character.GestureAt 200, 200
  'Character.Commands.Add "Think"
'  CommandList.Add Array("calc", "Opening Calculator", "calc")
'  'CommandList.Add Array("read", "Reading", "read")
'  Character.Commands.Add "time", "Display time", "time"
'  Character.Commands.Add "read", "Reading", "read"
'
'  Character.AutoPopupMenu = True
  
  'Character.MoveTo 200, 200
 ' Character.Play "Lookleft"
  'Character.Play "GestureLeft"
  'Character.Play "Lookright"
 'Character.Play "Gestureright"
End Sub

Private Sub Command3_Click()
Character.Play "GestureRight"
  Character.GestureAt 200, 400
...
'  Dim hwnd As Long
'  'Character.Speak "Reading!"
'        'CloseWindow GetForegroundWindow
'        'Character.Play "Read"
'               For Each s In CommandList
''          If UserInput.Name = s(0) Then
'                  Character.Speak s(1)
'''            If UCase(Left(s(3), 8)) = "WRITELN " Then
'''              Keys.PressString Right(Trim(s(3)), Len(s(3)) - 8) & Chr(13), True
'''            Else
'''              If UCase(Left(s(3), 6)) = "WRITE " Then
'''                Keys.PressString Right(Trim(s(3)), Len(s(3)) - 6), True
'''              Else
''                Shell s(3), vbNormalFocus
'''              End If
'''            End If
''          End If
'        Next s
...
For i = 1 To 2
 ...
 Character.Play "gesturedown"
  Character.Play "blink"
  Next
  Character.Speak "Dance"
...
Select Case UserInput.Name
    Case "time":
        ...
        Character.Speak strOutput
    Case "read":
        Character.Speak "Reading!"
        'CloseWindow GetForegroundWindow
        Character.Play "Read"
'    Case "Close":
'        Character.Speak "Closing Current Window!"
'        SendMessage GetForegroundWindow, WM_CLOSE, 0&, 0&
'    Case "Yes":
'        Character.Speak "Answering Yes to Dialog!"
'        Keys.PressKeyVK keyAlt, True, False, True
'        Keys.PressKey "Y"
'        Keys.PressKeyVK keyAlt, False, True, True
'    Case "No":
'        Character.Speak "Answering No Dialog!"
'        Keys.PressKeyVK keyAlt, True, False, True
'        Keys.PressKey "N"
'        Keys.PressKeyVK keyAlt, False, True, True
'    Case "Okay":
'        Character.Speak "Accepting Dialog!"
'        Keys.PressString Chr(13)
'    Case "Cancel":
'        Character.Speak "Cancelling Dialog!"
'        Keys.PressString Chr(27)
    Case "Bye":
        End
    Case Else
        For Each s In CommandList
